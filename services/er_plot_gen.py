...
plt.title("ER Graphs — Runtime Comparison", fontsize=12)
...
plt.title("ER Graphs — Bundle Phase Comparison", fontsize=12)
...
plt.title("ER Graphs — Speedup Analysis", fontsize=12)
...
plt.title("ER Graphs — Operation Cost Breakdown", fontsize=12)
...
print("Enhanced ER plots generated")